...
export default function Subscriptions() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl text-white mb-6">الاشتراكات</h1>
      ...
      <table className="w-full bg-gray-800 rounded">
        ...
        <tbody>
          {subscriptions.map((sub) => (
            <tr key={sub._id} className="text-white border-t border-gray-700">
              <td className="p-2">{sub.user?.username}</td>
              ...
              <td className="p-2">
                <button
                  onClick={() => handleStatusChange(sub._id, sub.status === 'active' ? 'cancelled' : 'active')}
